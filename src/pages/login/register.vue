	...
	<view class="register-container">
		...
		<view class="agreement">
			<label class="checkbox-label" @click="toggleAgreement">
				...
				<text class="agreement-text">我已阅读并同意<text class="agreement-link" @click="viewAgreement">《用户协议》</text>和<text class="agreement-link" @click="viewPrivacy">《隐私政策》</text></text>
			</label>
		</view>
	</view>
</template>
